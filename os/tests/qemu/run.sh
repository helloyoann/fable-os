#!/bin/sh
# QEMU boot-assertion suite for talk-os.  Entry point for `make test-qemu`.
#
...
# (TALKOS_TEST_OFFLINE, TALKOS_TEST_TIMEOUT, ...) and cases/boot.case for the
# case-file syntax.
set -eu
...
PYTHON=${TALKOS_TEST_PYTHON:-python3}
